...
(module $schedulers
  ...
  (func $scheduler1 (export "scheduler1") (param $main (ref $proc))
     (call $lwt-kt (cont.new (type $cont) (local.get $main)))
  )
  (func $scheduler2 (export "scheduler2") (param $main (ref $proc))
     (call $lwt-tk (cont.new (type $cont) (local.get $main)))
  )
  (func $scheduler3 (export "scheduler3") (param $main (ref $proc))
     (call $lwt-ykt (cont.new (type $cont) (local.get $main)))
  )
  (func $scheduler4 (export "scheduler4") (param $main (ref $proc))
...
(module
  ...
  (func $scheduler1 (import "schedulers" "scheduler1") (param $main (ref $proc)))
  (func $scheduler2 (import "schedulers" "scheduler2") (param $main (ref $proc)))
  (func $scheduler3 (import "schedulers" "scheduler3") (param $main (ref $proc)))
  (func $scheduler4 (import "schedulers" "scheduler4") (param $main (ref $proc)))
